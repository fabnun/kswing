...
public class CalendarPane extends MicrobaComponent implements
     ...
     * <p>
     * The returned date is guaranteed to pass the restriction check by the current {@link VetoPolicy}. Based on the value of {@link #stripTime} property, the returned date may be automatically
     * stripped.
     *
     ...
     * <p>
     * A {@link PropertyChangeEvent} may be fired, an {@link ActionEvent} may be fired.
     *
     ...
     * Sets current locale.
     * <p>
     * The locale is used to construct internal {@link Calendar} instances and affects visual representation of the control.
     *
     ...
     * <p>
     * The time zone is used to construct internal {@link Calendar} instances and affects visual representation of the control. The dates returned by {@link #getDate() } will have all time components
     * set to zero considering the current locale.
     *
     ...
     *
     * @return <code>true</code> if the today button is visible, <code>false</code> otherwise
     */
     ...
     * The today-button allows the user to quickly select current date.
     *
     * @param visible <code>true</code> to show the today-button <code>false</code> to hide
     */
     ...
     *
     * @return <code>true</code> if the none-button is visible, <code>false</code> otherwise
     */
     ...
     * The none-button allows the user to select empty date (null-date, no date).
     *
     * @param visible <code>true</code> to show the none-button <code>false</code> to hide
     */
     ...
     * The model is used to query localized resources for the control.
     *
     * @param resources a calendar resources model to set. Should not be <code>null</code>
     * @see CalendarResources
     */
     ...
     *
     * @return <code>true</code> if the number of every week is visible, <code>false</code> otherwise
     */
     ...
     *
     * @return <code>true</code> if {@link #getDate()} returns a stripped date, <code>false</code> otherwise
    ...
    /**
     * Makes {@link #getDate()} either strip the time portion of the date, or keep it.
     *
     * @param stripTime <code>true</code> to strip time, <code>false</code> to keep time
     */
     ...
     *
     * @param visible <code>true</code> to show the the number of every week <code>false</code> to hide
     */
    ...
    /**
     * Forces the control to commit current user's edit. The opertaion may fail because the date in the control may be restricted by current veto policy. If successfull, the current date of the
     * control may change, a {@link CommitEvent} is fired.
     *
    ...
    /**
     * Forces the control to revert current user's edit to reflect current control's date. The current date of the control may change, a {@link CommitEvent} is fired.
     *
     * @see #revertEdit()
     * @see #getFocusLostBehavior()
     * @see #setFocusLostBehavior(int)
     ...
     *
     * @param commit <code>true</code> to indicate commit, <code>false</code> to indicate revert
     * @see CommitEvent
     * @see CommitListener
     */
